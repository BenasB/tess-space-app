...
func main() {
	if len(os.Args) < 18 {
		log.Fatalln("Usage: go run . <input11.fits> <input12.fits> <input13.fits> <input14.fits> <input21.fits> <input22.fits> <input23.fits> <input24.fits> <input31.fits> <input32.fits> <input33.fits> <input34.fits> <input41.fits> <input42.fits> <input43.fits> <input44.fits> <output.png>")
	}
